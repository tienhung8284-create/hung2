...
template_str = open("module3/SS5/emails_template/html_template/thunghihoc.html", encoding="utf-8").read()
...
receiver_list = load_user("C:\pythonlevel2\module3/thunghihoc.json")
